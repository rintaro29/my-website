...
const Portfolio = () => {
  return (
    <>
      <div className=" container mx-auto mb-14 mt-5 flex  w-full flex-col items-center justify-between px-8 md:px-14 lg:px-24">
        <section className="w-full">
          <div className="mb-10 text-4xl font-bold">My Portfolio</div>
        </section>
